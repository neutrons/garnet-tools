...
class Normalization(SubPlan):
    ...
    def view(self, result_file):
        ...
        # PyQt6 -- override QT_API here since the parent process
        # (application.py) sets it to pyside6 for pyvistaqt/VTK and that
    ...
    def combine(self, files):
        ...
        data_files = [self.get_file(file, "data") for file in files]
        norm_files = [self.get_file(file, "norm") for file in files]
