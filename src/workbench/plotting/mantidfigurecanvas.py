...
#
# Vendored into garnet-tools: mantidqt's sliceviewer imports
# workbench.plotting.mantidfigurecanvas, which normally ships only with
# the full mantidworkbench conda package. We depend on mantidqt alone,
# so this minimal shim supplies that module without pulling in workbench.
"""
