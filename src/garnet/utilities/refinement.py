...
class NuclearStructureRefinement:
    ...
    def report(self, result, det_corr, run_corr):
        ...
        ellip = self.absorption_ellipsoid.ellipsoid_parameters(coeffs)
    ...
    def plot_sample_shape(self):
        ...
        params = self.absorption_ellipsoid.ellipsoid_parameters(self.coeffs)
        ...
        D, R, Q = self.absorption_ellipsoid.calculate_ellipsoid_surface(
            self.coeffs
        )
    ...
    def absorption_correction(self, coeffs):
        self.T, self.Tbar = self.absorption_ellipsoid.correction(
            coeffs, self.mu, self.ri_hat, self.sf_hat
        )
        return self.T
